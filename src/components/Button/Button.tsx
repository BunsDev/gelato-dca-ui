...
const Button: React.FC<ButtonProps> = ({ 
  label, isPrimary=true, isBold=false, isMono=true, isDisabled=false, fullWidth=true, padding, fontSize, onClick 
}) => {
  const className = useMemo(() => {
    ...
    return classes;
  }, [isPrimary, isBold, isMono, isDisabled, fontSize, fullWidth, padding]);
